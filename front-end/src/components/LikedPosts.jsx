                                    ...
                                    <Card className={styles.card} style={{ width: '18rem' }}>
                                        ...
                                        <Card.Body>
                                            ...
                                            <div className={styles.actions}>
                                                {(currUserId==post.user?.userId && <EditPostModal post={post} onUpdate={handleUpdatePost}/>)}
                                                <div className={styles.likes}><FontAwesomeIcon icon={faHeart} style={{color: "#ffffff",}} /> {post.likes.length}</div>
                                                <div className={styles.comments}><FontAwesomeIcon icon={faComment} style={{color: "#ffffff",}} /> {post.comments.length}</div>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                )}     
