      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body className={styles.modalBody}>
                <div className="mb-3">
                    ...
                    <input className="form-control" type="file" id="formFile" name='imagePath'/>
                </div>
                <div className={`form-floating`}>
                    <textarea className="form-control" placeholder="Post away your thoughts here..." id="floatingTextarea" name='caption'></textarea>
                    <label for="floatingTextarea" className={styles.labelClass}>Captions</label>
                </div>
