...
const Following = () => {
    ...
    const getFollowings = async () => {
        try{
            ...
            for(let followingId of followingIds){
                const userResponse = await axios.get(`/api/users/get-user-by-id/${followingId}`);
    ...
    return (
        <div className={styles.followingContainer}>       
            <a className="btn collapsed" data-bs-toggle="collapse" href="#followingCollapse" role="button" aria-expanded="false" aria-controls="collapseExample">
                <div className={styles.followingText}>
                    <div>
                    <i class="fa-solid fa-check"></i>Following
                    </div>
                    <div className={styles.followingsCount}>
                        {followings.length}
                    </div>
                </div>
            </a>
